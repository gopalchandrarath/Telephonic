...
public class Customers {
	...
	public static void main(String[] args) {
		...
		sel.click();
		driver.findElement(By.id("user.userName")).sendKeys("rahulkantlatest");
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy", "document.body.scrollHeight");
		String submitButton = "//*[@id=\"main\"]/div[5]/ul/li[1]/a";
		js.executeScript("arguments[0].click();", driver.findElement(By.xpath(submitButton)));
		driver.close();
	}
